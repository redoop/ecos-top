...
void Vsoc_tb___024root__trace_chg_0_sub_0(Vsoc_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp);
...
void Vsoc_tb___024root__trace_chg_0_sub_0(Vsoc_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+0,(vlSelfRef.soc_tb__DOT__clk));
    bufp->chgBit(oldp+1,(vlSelfRef.soc_tb__DOT__rst_n));
}
